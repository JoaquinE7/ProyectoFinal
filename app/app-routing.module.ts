...
{ path: 'singin', loadChildren: () => import('./components/pages/singin/singin.module').then(m => m.SinginModule) },
{ path: 'singup', loadChildren: () => import('./components/pages/regist/regist.module').then(m => m.RegistModule) },
